        ...
        <div className="mb-12 grid grid-cols-4 gap-4">
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <circle cx="16" cy="8" r="2" fill="#94A3B8" />
                <path d="M12 14C10.3431 14 9 15.3431 9 17V20H15V17C15 15.3431 13.6569 14 12 14Z" fill="#94A3B8" />
              </svg>
            </div>
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M5 19L19 5M19 5H10M19 5V14" stroke="#94A3B8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </div>
            <p className="text-2xl font-semibold mb-2" style={{ color: "#0F172A" }}>
              42
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <text x="8" y="16" fontSize="14" fontWeight="bold" fill="#94A3B8">%</text>
              </svg>
            </div>
            <p className="text-2xl font-semibold mb-2" style={{ color: "#0F172A" }}>
              +3.2%
